...
plt.plot(xvals, yvals3, 'co-', linewidth=2) #blocking
plt.plot(xvals, yvals4, 'co-.', linewidth=2) #blocking_AVX
plt.plot(xvals, yvals5, 'so-', linewidth=2) #inline2
plt.plot(xvals, yvals6, 'so-', linewidth=2) #inline2x2
plt.plot(xvals, yvals7, 'bo-', linewidth=2) #inline2x4
plt.plot(xvals, yvals8, 'ko-.', linewidth=2) #baseline_opts
plt.plot(xvals, yvals9, 'ko-', linewidth=2) #baseline
plt.plot(xvals, yvals10, 'mo-.', linewidth=2) #onestep
plt.plot(xvals, yvals11, 'mo-.', linewidth=2) #onestep_AVX
plt.plot(xvals, yvals12, 'yo-', linewidth=2) #storegrey
